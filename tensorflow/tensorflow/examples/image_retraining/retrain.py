...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/Users/Sidhu/TJHSST/12thGrade/Projects/OcuVision/tensorflow/tensorflow/examples/label_image/output_graph.pb',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='/Users/Sidhu/TJHSST/12thGrade/Projects/OcuVision/tensorflow/tensorflow/examples/label_image/output_labels.txt',
